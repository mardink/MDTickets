...
$lastlogin = MdticketsHelperComputers::getLastlogin($user_id);
//Get options
...
<div class="row-fluid">
    ...
    <form name="adminForm" id="adminForm" action="index.php?option=com_mdtickets&view=computers&Itemid=<?php echo $menu_id;?>" method="post">
        <input type="hidden" name="option" id="option" value="com_mdtickets" />
        <input type="hidden" name="view" id="view" value="computers" />
