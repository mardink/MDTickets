...
<form action="index.php" method="post" id="adminForm" class="form-validate" onsubmit="return isValid()"
    ...
    <input type="hidden" id="mdtickets_computer_id" name="mdtickets_user_id" value="<?php echo $this->item->mdtickets_user_id ?>" />
    ...
    <div id="mdtickets_toolbar" class="row well btn-toolbar">
        <div id="btn_save" class="btn-group">
            ...
            <a href="index.php?option=com_mdtickets&view=users&Itemid=<?php echo $menu_id;?>"  class="btn">
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="row">
                <div class="span2">
                    <label for="username" class="control-label"><?php echo JText::_('COM_MDTICKETS_COMPUTERS_FIELD_USERNAME') ?></label>
                </div>
                <div class="span4">
                    <input type="text" name="username" id="username"  value="<?php echo $this->item->username?>" class="required"/>
                </div>
            </div>
            <div class="row">
                <div class="span2">
